<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
			...
			<div class="description_block" style="padding-bottom: 60px;">
				<span class="title_block">Наши Контакты</span>
				<div class="row">
		...
		<div class="row contacts_block_s">
			<div class="info_section col-md-5 col-md-offset-1 col-lg-5 col-lg-offset-1">
			...
			<div class="feedback_section col-md-5 col-lg-5">
				<?$APPLICATION->IncludeComponent(
						"bitrix:main.include",
						".default",
						array(
